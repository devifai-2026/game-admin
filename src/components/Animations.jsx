...
const categories = [
  { id: 1, name: 'Pouring Water/Milk', icon: '💧', color: '#4A90E2' },
  { id: 2, name: 'Flower Showers', icon: '🌸', color: '#E91E63' },
  { id: 3, name: 'Lighting Lamp', icon: '🪔', color: '#FF9800' },
  { id: 4, name: 'Offerings Fruits/Sweets', icon: '🍎', color: '#4CAF50' }
]
...
const Animations = () => {
  ...
  useEffect(() => {
    const saved = JSON.parse(localStorage.getItem('animationImages') || '{}')
  ...
  const removeSavedImage = (categoryId, imageId) => {
    ...
    localStorage.setItem('animationImages', JSON.stringify(updated))
  }
  ...
  const handleEditSavedImage = async () => {
    ...
    if (newImageFile && newImageFile.file) {
      ...
      // Keep the existing image data - THIS IS THE FIX
      updatedImageData = {
        ...editingImage,
        name: editForm.name,
        categoryId: newCategoryId,
    ...
    localStorage.setItem('animationImages', JSON.stringify(updatedNewCategory))
        ...
        <div className="border-t pt-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
            <div>
              ...
              <p className="text-gray-600 text-sm mt-1">
                Upload and manage animation images for this category
              </p>
            </div>
          ...
          <div className="mb-8 p-4 border-2 border-dashed border-gray-300 rounded-lg bg-gray-50">
            ...
            {(categoryImages[selectedCategory] || []).length > 0 ? (
              ...
              <div className="text-center py-8 border-2 border-dashed border-gray-300 rounded-lg">
                ...
                <p className="text-sm text-gray-400 mt-1">Click "Upload Images" to add animation images</p>
              </div>
            )}
          </div>
          ...
          <div className="mt-8">
            ...
            {(savedCategoryImages[selectedCategory] || []).length > 0 ? (
              ...
              <div className="text-center py-8 border-2 border-dashed border-gray-300 rounded-lg">
                <p className="text-gray-500">No saved images for this category</p>
          ...
          <div className="mt-6 p-4 rounded-lg" 
            ...
            <div className="flex items-center justify-between">
              <div>
                <h5 className="font-semibold text-sm">Category Statistics</h5>
